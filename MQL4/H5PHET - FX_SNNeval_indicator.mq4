// H5PHET - FX_SNNeval_indicator
// Crea una ventana separada con el indicador de entrenamiento y el indicador generado desde SNN
// los genera la primera vez desde hace un numero inicial de  minutos (def=20k).


#property indicator_separate_window
#property indicator_buffers 2  // actual y variación por cada uno de los tres TF: 1M, 15M y 4H
