...
extern double decNormD=0.000001; //(0.000001)decremento pir shift de la norma dinámica.0.001=4.1770,0.0001=9.7558,0.00001=10.8345,0.000001=11.0309,0.0000001=11.0901
...
// i =shift.
{
    ...
    double tmp,tmp2;
/* Probar después entrada HOBV(i) = HOBV(i+1)+(color[i]*iVolume(i))
*/
...
// maximo 9000 neuronas.
    ...
    {
      Print("Error calculando las entradas");   
      return;
    }
